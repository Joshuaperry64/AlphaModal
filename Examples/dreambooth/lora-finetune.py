...
@app.function(
    ...
    mounts=[modal.mount.Mount.from_local_dir(r"C:\Users\josh6\Downloads\moms", remote_path="/img")],
...
def train(instance_example_urls, config):
    ...
    # Use the locally mounted directory directly instead of downloading URLs
    img_path = "/img"
