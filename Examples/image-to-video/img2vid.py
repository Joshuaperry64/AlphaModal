...
class Inference:
    ...
    def load_pipeline(self):
        ...
        # The safety checker must be disabled to allow animation of NSFW content.
        print("Disabling safety checker for unrestricted video generation.")
    ...
    async def read_root(request: fastapi.Request):
        return templates.TemplateResponse(
            "index.html",
            {
                ...
                "default_prompt": "subtle breathing, hair moving slightly",
            },
        )
